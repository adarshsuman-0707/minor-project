        ...
        <!-- Page Content -->
          ...
          <div class="form-group">
            <div class="form-label-group">
                ...
                <div class="form-row">
                    ...
                    <!-- <div class="form-label-group"> -->
                     ...
                     <div class="left col-md-5" >
                         ...
                         <div class="form-label-group">
                        <textarea  rows="1"  class="form-control" name="others" placeholder="Others"></textarea>
                  </div>
                       </div>
             ...
             <div class="form-group fix">
                  <div class="form-label-group">
                        <textarea  rows="2"  class="form-control" name="address" placeholder="Adderess"><?php echo $add; ?></textarea>
                  </div>
            </div>
               <div class="form-group">
                <div class="form-row">
                   ...
                   <div class="col-md-5 left">
                        <select name="city" class="form-control">
                          <option value="Bhopal" <?php if ($ct=="Bhopal") {
                          echo "selected";
                        } ?> >Bhopal</option>
